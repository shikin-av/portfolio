          ...
          "elements": [
              {
                  ...
                  <li>Коммуникации со стороной заказчика</li>
          ...
          "elements": [
              {
                  ...
                  "type": "texteditor",
                  "content": `<h2 style=\"text-align:center;\">Приложение доставки здорового питания по Европе, Америке и странам Ближнего Востока<\/h2><br>
                    <p>React-native приложение под iOS и Android, содержащее более 20ти экранов.</p><br>
                    <p>Возможности не только по покупке и доставке товаров, а так же программа лояльности пользователей, премиум подписки, дисконтные и подарочные карты и т.д.</p><br>
                    <p>Сотни тысяч пользователей по всему миру</p>`
              }
          ],
          "color": "#EEEEEE"
      },
