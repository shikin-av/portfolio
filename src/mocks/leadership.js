export default {
  ...
  "rows": [
          ...
          "elements": [
              {
                  ...
                  "type": "texteditor",
                  "content": `
                  <h2 style="text-align:center;">Участвовал в роли Team lead на 2х проектах российского банка</h2>`
              },
          ],
          "color": "#EEEEEE"
      },
          ...
          "elements": [
              {
                  ...
                  "type": "texteditor",
                  "content": `
                    <h2 style="text-align:center;">Frontend team lead</h2>
                    <ul>
                    <li><b>Описание проекта:</b> Система внутреннего обмена информацией</li>
        ...
        "elements": [
            {
                ...
                "type": "texteditor",
                "content": `
                  <h2 style="text-align:center;">Project team lead</h2>
                  <ul>
                  <li><b>Описание проекта:</b> Вспомогательная система для первого проекта</li>
    ...
    {
        "id": 0.988230938910843,
        "type": "fullwidth",
        "elements": [
            {
                "id": 0.679661047130252,
                "type": "texteditor",
                "content": `<p>(Название банка скрыто и скриншоты отсутствуют в связи с обязательствами о неразглашении коммерческой информации)</p>`
            },
        ],
        "color": "#FAFAFA"
    },
